...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CktHQEtu.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Do02dZ9Q.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Di13q72S.mjs"),
		import("./start-Dj4EWobb.mjs"),
