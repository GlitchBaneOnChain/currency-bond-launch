// Authenticates inbound cron/webhook requests against a shared secret.
// Set CRON_SECRET (and optionally CRON_SECRET_PREVIOUS during rotation) in
// your host env. Sends 500 if unset, 401 if the bearer token does not match.
